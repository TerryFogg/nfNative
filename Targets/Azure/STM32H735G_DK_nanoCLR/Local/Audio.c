...
typedef struct
{
    ...
    uint32_t ActiveFrameLength; /*!< Specifies the Frame synchronization active level
...
#define IS_SAI_BLOCK_MCK_OUTPUT(VALUE) (((VALUE) == SAI_MCK_OUTPUT_ENABLE) || ((VALUE) == SAI_MCK_OUTPUT_DISABLE))
