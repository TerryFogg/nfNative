...
bool TouchInterface::Initialize(TouchInterfaceConfig config)
{
    ...
    /*** Configure the GPIOs ***/
    __HAL_RCC_GPIOD_CLK_ENABLE();      // Enable Port with I2C4 SCL and SDA pins
    ...
    __HAL_RCC_I2C4_CLK_ENABLE(); // Enable I2C4 clock
    __HAL_RCC_I2C4_FORCE_RESET(); // Force the I2C peripheral clock reset
    __HAL_RCC_I2C4_RELEASE_RESET(); // Release the I2C peripheral clock reset
    ...
    HAL_NVIC_SetPriority((IRQn_Type)(TS_INT_EXTI_IRQn), 15, 0x00);
